...
function CorrectKeyAndLoadTheScript()
         loadstring(game:HttpGet('https://raw.githubusercontent.com/GhostPlayer352/Test4/main/GhostHub'))() --This Where You Put The Script That Will Be Loaded If The Key Is Correct
end
